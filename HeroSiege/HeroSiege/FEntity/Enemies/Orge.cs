...
namespace HeroSiege.FEntity.Enemies
{
    class Orge : Enemy
    {
        ...
        protected override void AddSpriteAnimations()
        {
            ...
            //--- Death animation ---//
            sprite.AddAnimation("Death_1", new FrameAnimation(ResourceManager.GetTexture("Orge"), 0, 576, 64, 64, 3, FRAME_DURATION_DEATH, new Point(1, 3), false));
            sprite.AddAnimation("Death_2", new FrameAnimation(ResourceManager.GetTexture("Orge"), 0, 640, 64, 64, 3, FRAME_DURATION_DEATH, new Point(1, 3), false));
